...
struct csiphy_reg_t csiphy_2ph_v2_2_1_reg[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
		...
		{0x0094, 0xD7, 0x00, CSIPHY_DNP_PARAMS},
		{0x005C, 0x00, 0x00, CSIPHY_DNP_PARAMS},
		{0x0094, 0xD7, 0x00, CSIPHY_DNP_PARAMS},
		{0x005C, 0x00, 0x00, CSIPHY_DNP_PARAMS},
		{0x005C, 0x00, 0x00, CSIPHY_DNP_PARAMS},
	},
	{
		...
		{0x0494, 0xD7, 0x00, CSIPHY_DNP_PARAMS},
		{0x045C, 0x00, 0x00, CSIPHY_DNP_PARAMS},
		{0x0094, 0xD7, 0x00, CSIPHY_DNP_PARAMS},
		{0x005C, 0x00, 0x00, CSIPHY_DNP_PARAMS},
		{0x005C, 0x00, 0x00, CSIPHY_DNP_PARAMS},
	},
	{
		...
		{0x0894, 0xD7, 0x00, CSIPHY_DNP_PARAMS},
		{0x085C, 0x00, 0x00, CSIPHY_DNP_PARAMS},
		{0x0094, 0xD7, 0x00, CSIPHY_DNP_PARAMS},
		{0x005C, 0x00, 0x00, CSIPHY_DNP_PARAMS},
		{0x005C, 0x00, 0x00, CSIPHY_DNP_PARAMS},
	},
	{
		...
		{0x0C94, 0xD7, 0x00, CSIPHY_DNP_PARAMS},
...
struct csiphy_reg_t csiphy_2ph_v2_2_1_combo_mode_reg[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
		{0x0094, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x00A0, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0090, 0x0F, 0x00, CSIPHY_DEFAULT_PARAMS},
		...
		{0x005C, 0x54, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0060, 0xFD, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0064, 0x7F, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0020, 0x00, 0x00, CSIPHY_DNP_PARAMS},
	},
	{
		{0x0494, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x04A0, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		...
		{0x045C, 0x54, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	},
	{
		...
		{0x085C, 0x54, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0860, 0xFD, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	},
	{
		...
		{0x0C08, 0x19, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		{0x0C10, 0x52, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0C10, 0x52, 0x00, CSIPHY_DNP_PARAMS},
		{0x0C10, 0x52, 0x00, CSIPHY_DNP_PARAMS},
	},
	{
		{0x0E94, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		...
		{0x0E08, 0x19, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		{0x0E10, 0x52, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0E10, 0x52, 0x00, CSIPHY_DNP_PARAMS},
		{0x0E10, 0x52, 0x00, CSIPHY_DNP_PARAMS},
		{0x0E10, 0x52, 0x00, CSIPHY_DNP_PARAMS},
	}
};

struct csiphy_reg_t csiphy_3ph_v2_2_1_reg[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
...
/* csi_3ph_1dphy_3p0Gbps_2cphy_4p5Gsps_double_sync_mission_mode */
struct csiphy_reg_t
csiphy_v2_2_1_1l2ph_2l3ph_combo_mode_reg[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
	...
	},
	{
		...
		{0x0A08, 0x00, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
...
/* csi_3ph_2dphy_3p0Gbps_1cphy_2p5Gsps_double_sync_mission_mode */
struct csiphy_reg_t
csiphy_v2_2_1_2l2ph_1l3ph_combo_mode_reg[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
		{0x0AF0, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0A68, 0xF1, 0x00, CSIPHY_DEFAULT_PARAMS},
		...
		{0x0A88, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0A8C, 0x35, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0A90, 0x02, 0x0A, CSIPHY_DEFAULT_PARAMS},
		{0x0E94, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0EA0, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0E90, 0x0F, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0E98, 0x08, 0x00, CSIPHY_DEFAULT_PARAMS},
			...
			.per_lane_info = {
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0278, 0x5F, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0278, 0x5F, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0674, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0678, 0x5F, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0678, 0x5F, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0688, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0A78, 0x5F, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0A78, 0x5F, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0A88, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
			...
			.per_lane_info = {
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0A78, 0x5F, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0A78, 0x5F, 0x00,
							 CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0A88, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A8C, 0x77, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A90, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
			...
			.per_lane_info = {
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0278, 0x5F, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0288, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x028C, 0x07, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0290, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0678, 0x5F, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0688, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x068C, 0x07, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0690, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0A78, 0x5F, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0A88, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A8C, 0x07, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A90, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A0C, 0x66, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
						{0x0A08, 0x00, 0x00, CSIPHY_SETTLE_CNT_HIGHER_BYTE},
						{0x0A10, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A14, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0AF0, 0xEF, 0x00, CSIPHY_DEFAULT_PARAMS},
					},
				},
			},
		},
			...
			.per_lane_info = {
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0274, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0278, 0x3F, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0278, 0x3F, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0288, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0670, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0674, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0678, 0x3F, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0678, 0x3F, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0688, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x068C, 0x75, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0690, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0A70, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A74, 0x00, 0x0A, CSIPHY_DEFAULT_PARAMS},
						{0x0A78, 0x3F, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0A78, 0x3F, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0A88, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A8C, 0x75, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A90, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
			...
			.per_lane_info = {
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0270, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0274, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0278, 0x26, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0278, 0x26, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0288, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x028C, 0x75, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0290, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0670, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0674, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0678, 0x26, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0678, 0x26, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0688, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x068C, 0x75, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0690, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0A70, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A74, 0x00, 0x0A, CSIPHY_DEFAULT_PARAMS},
						{0x0A78, 0x26, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0A78, 0x26, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0A88, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A8C, 0x75, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A90, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
			...
			.per_lane_info = {
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0270, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0274, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0278, 0x12, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0278, 0x12, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0288, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x028C, 0x75, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0290, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0670, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0674, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0678, 0x12, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0678, 0x12, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0688, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x068C, 0x75, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0690, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0A70, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A74, 0x00, 0x0A, CSIPHY_DEFAULT_PARAMS},
						{0x0A78, 0x12, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0A78, 0x12, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0A88, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A8C, 0x75, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A90, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
			...
			.per_lane_info = {
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0270, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0274, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0278, 0x24, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0278, 0x24, 0x00,
							 CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0288, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x028C, 0x35, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0290, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0670, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0674, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0678, 0x24, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0678, 0x24, 0x00,
							 CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0688, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x068C, 0x35, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0690, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0A70, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A74, 0x00, 0x0A, CSIPHY_DEFAULT_PARAMS},
						{0x0A78, 0x24, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0A78, 0x24, 0x00,
							 CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0A88, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A8C, 0x35, 0x00, CSIPHY_DEFAULT_PARAMS},
			...
			.per_lane_info = {
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0270, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0274, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0278, 0x0F, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0278, 0x0F, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0288, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x028C, 0x75, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0290, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0670, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0674, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0678, 0x0F, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0678, 0x0F, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0688, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x068C, 0x75, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0690, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0A70, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A74, 0x00, 0x0A, CSIPHY_DEFAULT_PARAMS},
						{0x0A78, 0x0F, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0A78, 0x0F, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0A88, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A8C, 0x75, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A90, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
			...
			.per_lane_info = {
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0270, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0274, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0278, 0x0C, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0278, 0x0C, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0288, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x028C, 0x75, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0290, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0670, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0674, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0678, 0x0C, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0678, 0x0C, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0688, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x068C, 0x75, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0690, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0A70, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A74, 0x00, 0x0A, CSIPHY_DEFAULT_PARAMS},
						{0x0A78, 0x0C, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0A78, 0x0C, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0A88, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A8C, 0x75, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A90, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
			...
			.per_lane_info = {
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0270, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0274, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0278, 0x09, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0278, 0x09, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0288, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x028C, 0x75, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0290, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0670, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0674, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0678, 0x09, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0678, 0x09, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0688, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x068C, 0x75, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0690, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0A70, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A74, 0x00, 0x0A, CSIPHY_DEFAULT_PARAMS},
						{0x0A78, 0x09, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0A78, 0x09, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0A88, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A8C, 0x75, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A90, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
			...
			.per_lane_info = {
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0270, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0274, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0278, 0x08, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0278, 0x08, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0288, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x028C, 0x75, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0290, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0670, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0674, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0678, 0x08, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0678, 0x08, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0688, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x068C, 0x75, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0690, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0A70, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A74, 0x00, 0x0A, CSIPHY_DEFAULT_PARAMS},
						{0x0A78, 0x08, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0A78, 0x08, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0A88, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A8C, 0x75, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A90, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
			...
			.per_lane_info = {
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0274, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0278, 0x07, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0278, 0x07, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0288, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x028C, 0x77, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0290, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x020C, 0x19, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0674, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0678, 0x07, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0678, 0x07, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0688, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x068C, 0x77, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0690, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x060C, 0x19, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
				...
				},
				{
					...
					.csiphy_data_rate_regs = {
						...
						{0x0A74, 0x00, 0x0A, CSIPHY_DEFAULT_PARAMS},
						{0x0A78, 0x07, 0x00, CSIPHY_CDR_SHORT_LN_SETTINGS},
						{0x0A78, 0x07, 0x00, CSIPHY_CDR_STANDARD_LN_SETTINGS},
						{0x0A88, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A8C, 0x77, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A90, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
						{0x0A0C, 0x19, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
...
struct csiphy_reg_parms_t csiphy_v2_2_1 = {
	...
	.csiphy_common_array_size = ARRAY_SIZE(csiphy_common_reg_2_2_1),
	...
	.csiphy_3ph_config_array_size = 24,
