...
/**
 * @brief : API to map a known phy_addr in the fence queue region
 */
int cam_smmu_map_phy_mem_in_fence_queue_region(int smmu_hdl, phys_addr_t phy_addr,
