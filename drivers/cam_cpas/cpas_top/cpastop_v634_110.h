...
#ifndef _CPASTOP_V634_110_H_
#define _CPASTOP_V634_110_H_

#define TEST_IRQ_ENABLE 0

static struct cam_camnoc_irq_sbm cam_cpas_v634_110_irq_sbm = {
	.sbm_enable = {
		...
		.value = 0x1 | /* SBM_FAULTINEN0_LOW_PORT0_MASK */
			...
			(TEST_IRQ_ENABLE ?
			0x80 :
			0x0) | /* SBM_FAULTINEN0_LOW_PORT7_MASK */
			0x100 | /* SBM_FAULTINEN0_LOW_PORT8_MASK */
			0x200 | /* SBM_FAULTINEN0_LOW_PORT9_MASK */
			0x400 | /* SBM_FAULTINEN0_LOW_PORT10_MASK */
			0x800 | /* SBM_FAULTINEN0_LOW_PORT11_MASK */
			0x1000 | /* SBM_FAULTINEN0_LOW_PORT12_MASK */
			0x2000, /* SBM_FAULTINEN0_LOW_PORT13_MASK */
	},
	.sbm_status = {
...
static struct cam_camnoc_irq_err
	...
	},
	{
		...
		.err_enable = {
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.enable = true,
			.offset = 0xB920, /* CAM_NOC_IPE_RD_0_NIU_DECERREN_LOW */
			.value = 0xFF,
		},
		.err_status = {
			.access_type = CAM_REG_TYPE_READ,
			.enable = true,
			.offset = 0xB910, /* CAM_NOC_IPE_RD_0_NIU_DECERRSTATUS_LOW */
		},
		.err_clear = {
			.access_type = CAM_REG_TYPE_WRITE,
			.enable = true,
			.offset = 0xB918, /* CAM_NOC_IPE_RD_0_NIU_DECERRCLR_LOW */
		},
	},
	{
		...
		.err_enable = {
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.enable = true,
			.offset = 0x9D20, /* CAM_NOC_IPE_RD_1_NIU_DECERREN_LOW */
			.value = 0xFF,
		},
		.err_status = {
			.access_type = CAM_REG_TYPE_READ,
			.enable = true,
			.offset = 0x9D10, /* CAM_NOC_IPE_RD_1_NIU_DECERRSTATUS_LOW */
		},
		.err_clear = {
			.access_type = CAM_REG_TYPE_WRITE,
			.enable = true,
			.offset = 0x9D18, /* CAM_NOC_IPE_RD_1_NIU_DECERRCLR_LOW */
		},
	},
	{
...
static struct cam_camnoc_specific
	cam_cpas_v634_110_camnoc_specific[] = {
	{
	...
	},
	{
		...
		.danger_lut = {
			...
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0xB840, /* IPE_RD_0_NIU_DANGERLUT_LOW */
			.value = 0x0,
		},
		.safe_lut = {
			.enable = false,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0xB848, /* IPE_RD_0_NIU_SAFELUT_LOW */
			.value = 0xFFFF,
		},
		.ubwc_ctl = {
			.enable = false,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0xB908, /* IPE_RD_0_NIU_DECCTL_LOW */
			.value = 1,
		},
		.qosgen_mainctl = {
			.enable = false,
		...
		.qosgen_shaping_low = {
			...
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0xBD20, /* IPE_RD_0_QOSGEN_SHAPING_LOW */
			.value = 0x0,
		},
		.qosgen_shaping_high = {
			.enable = false,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0xBD24, /* IPE_RD_0_QOSGEN_SHAPING_HIGH */
			.value = 0x0,
		},
	},
	{
	...
	},
	{
		...
		.priority_lut_low = {
			...
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x9030, /* BPS_RD_NIU_PRIORITYLUT_LOW */
			.value = 0x33333333,
		},
		.priority_lut_high = {
			.enable = true,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x9034, /* BPS_RD_NIU_PRIORITYLUT_HIGH */
			.value = 0x33333333,
		},
		.urgency = {
			.enable = true,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x9038, /* BPS_RD_NIU_URGENCY_LOW */
			.value = 0x0003,
		},
	},
	{
		...
		.priority_lut_low = {
			...
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x9230, /* CDM_NIU_PRIORITYLUT_LOW */
			.value = 0x33333333,
		},
		.priority_lut_high = {
			.enable = true,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x9234, /* CDM_NIU_PRIORITYLUT_HIGH */
			.value = 0x33333333,
		},
		.urgency = {
			.enable = true,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0x9238, /* CDM_NIU_URGENCY_LOW */
			.value = 0x1003,
		},
	},
	{
		.port_type = CAM_CAMNOC_JPEG_RD,
		.port_name = "JPEG_RD",
		.enable = true,
		.priority_lut_low = {
			.enable = true,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0xA030, /* JPEG_RD_NIU_PRIORITYLUT_LOW */
			.value = 0x22222222,
		},
		.priority_lut_high = {
			.enable = true,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0xA034, /* JPEG_RD_NIU_PRIORITYLUT_HIGH */
			.value = 0x22222222,
		},
		.urgency = {
			.enable = true,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0xA038, /* JPEG_RD_NIU_URGENCY_LOW */
			.value = 0x1020,
		},
	},
};

static struct cam_camnoc_err_logger_info cam634_cpas110_err_logger_offsets = {
...
static struct cam_cpas_hw_errata_wa_list cam634_cpas110_errata_wa_list = {
...
static struct cam_cpas_hw_clk_gate_info
	cam634_cpas110_clk_core_en_info[] = {
	{
...
static struct cam_camnoc_info cam634_cpas110_camnoc_info = {
	.specific = &cam_cpas_v634_110_camnoc_specific[0],
	.specific_size = ARRAY_SIZE(cam_cpas_v634_110_camnoc_specific),
	.irq_sbm = &cam_cpas_v634_110_irq_sbm,
	.irq_err = &cam_cpas_v634_110_irq_err[0],
	.irq_err_size = ARRAY_SIZE(cam_cpas_v634_110_irq_err),
	.err_logger = &cam634_cpas110_err_logger_offsets,
	.errata_wa_list = &cam634_cpas110_errata_wa_list,
	.ife_core_clk_list = &cam634_cpas110_clk_core_en_info[0],
	.ife_core_clk_list_size = ARRAY_SIZE(cam634_cpas110_clk_core_en_info),
};

static struct cam_cpas_camnoc_qchannel cam634_cpas110_qchannel_info = {
	.qchannel_ctrl   = 0x5C,
