...
#define _CPASTOP_V634_100_H_

#define TEST_IRQ_ENABLE 0

static struct cam_camnoc_irq_sbm cam_cpas_v634_100_irq_sbm = {
	.sbm_enable = {
...
static struct cam_camnoc_specific
	cam_cpas_v634_100_camnoc_specific[] = {
	{
	...
	},
	{
		...
		.priority_lut_low = {
			...
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0xA230, /* JPEG_WR_NIU_PRIORITYLUT_LOW */
			.value = 0x22222222,
		},
		.priority_lut_high = {
			.enable = true,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0xA234, /* JPEG_NIU_PRIORITYLUT_HIGH */
			.value = 0x22222222,
		},
		.urgency = {
			.enable = true,
			.access_type = CAM_REG_TYPE_READ_WRITE,
			.masked_value = 0,
			.offset = 0xA238, /* JPEG_NIU_URGENCY_LOW */
			.value = 0x1020,
		},
	},
	{
...
static struct cam_camnoc_err_logger_info cam634_cpas100_err_logger_offsets = {
...
static struct cam_cpas_hw_errata_wa_list cam634_cpas100_errata_wa_list = {
...
static struct cam_camnoc_info cam634_cpas100_camnoc_info = {
	...
	.irq_sbm = &cam_cpas_v634_100_irq_sbm,
	.irq_err = &cam_cpas_v634_100_irq_err[0],
